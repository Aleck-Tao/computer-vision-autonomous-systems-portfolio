...
| Safe autonomous systems | Separation of learned intent, deterministic validation, control boundary, and post-flight evidence | [Integrated UAV project](../projects/01-ai-agent-assisted-autonomous-uav/) | Runtime assurance, reachability-informed guards, and safety-case construction |
